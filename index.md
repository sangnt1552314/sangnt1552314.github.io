...
I am a PhD student in Computer Science working on AI, NLP, and LLMs at the [National University of Singapore](https://www.nus.edu.sg/). Before joining NUS, I obtained my B.Eng and M.Eng in Computer Science from [Ho Chi Minh City University of Technology - Vietnam National University (HCMUT-VNU)](https://hcmut.edu.vn/en).

Besides, I had been a Backend Web Developer at [Younet Social](https://younetsocial.com/), since I graduated in 2020.
...
- **Cross-Lingual Consensus: Aligning Multilingual Cultural Knowledge via Multilingual Self-Consistency**  
  AI Soegeng, P Sutanto, **TS Nguyen**. *Proceedings of the 1st Workshop on Multilinguality in the Era of Large Language Models*, 2026. [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:YsMSGLbcyi4C)

- **Sentence-Aware Bahnaric-Vietnamese Lexical Mapping with Contrastive Contextual Representations**  
  TT Nguyen, PT Tran-Truong, L Nguyen, **TS Nguyen**, T Quan. *Second Workshop on Language Models for Underserved Communities (LM4UC)*, 2026. [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:Y0pCki6q_DkC)

- **Low-Rank Adaptation Approach for Vietnamese-Bahnaric Lexical Mapping from Non-Parallel Corpora**  
  [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:9yKSN-GCB0IC)

- **Text-JEPA: A Joint Embedding Predictive Architecture for the Conversion of Natural Language into First-Order Logic**  
  T Le, P Thai, **S Nguyen**, M Hua, N Pham, T Bui, T Quan, T Bui. *International Conference on Computational Collective Intelligence*, 200-214, 2025. [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:zYLM7Y9cAGgC)

- **Speaking in Words, Thinking in Logic: A Dual-Process Framework in QA Systems**  
  T Bui, T Le, P Thai, **S Nguyen**, M Hua, N Pham, T Bui, T Quan. *2025 International Joint Conference on Neural Networks (IJCNN)*, 1-8, 2025. [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:2osOgNQ5qMEC)

- **Revitalizing Bahnaric Language through Neural Machine Translation: Challenges, Strategies, and Promising Outcomes**  
  HNK Vo, DD Le, TMD Phan, **TS Nguyen**, QN Pham, NO Tran, QD Nguyen, et al. *Proceedings of the AAAI Conference on Artificial Intelligence* 38 (21), 23360, 2024. [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:u5HHmVD_uO8C)

- **Leveraging Sentence-Oriented Augmentation and Transformer-Based Architecture for Vietnamese-Bahnaric Translation**  
  **TS Nguyen**, QN Pham, T Quan. *VNUHCM Journal of Engineering and Technology* 6 (4), 2099-2117, 2024. [[Scholar]](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=1RyWgLgAAAAJ&citation_for_view=1RyWgLgAAAAJ:u-x6o8ySG0sC)
...
- [Google Scholar](https://scholar.google.com/citations?user=1RyWgLgAAAAJ&hl=en&oi=ao)
- [Twitter/X](https://x.com/sangeo97)
- [Email](mailto:tansang.nguyen@u.nus.edu)